...
FROM usdotfhwastol/autoware.ai:3.4.0-29-g2a5d777-SNAPSHOT AS source-code
...
FROM usdotfhwastol/autoware.ai:3.4.0-29-g2a5d777-SNAPSHOT AS install
...
FROM usdotfhwastol/autoware.ai:3.4.0-29-g2a5d777-SNAPSHOT
