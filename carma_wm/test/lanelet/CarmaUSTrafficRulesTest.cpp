...
TEST(CarmaUSTrafficRules, carmaUSTrafficRules)
{
  ...
  std::shared_ptr<DigitalSpeedLimit> dsl_lanelet(new DigitalSpeedLimit(DigitalSpeedLimit::buildData(lanelet::utils::getId(), 25_kmh, {ll_1, ll_2, ll_3, ll_4}, {}, {lanelet::Participants::Vehicle})));
  ...
  std::shared_ptr<DirectionOfTravel> dot_bi(new DirectionOfTravel(DirectionOfTravel::buildData(lanelet::utils::getId(), {ll_4}, DirectionOfTravel::BiDirectional, {lanelet::Participants::Vehicle})));
  ll_4.addRegulatoryElement(dot_bi);
  // 7. create non-passable control line on left of first lanelet
  std::shared_ptr<PassingControlLine> pcl_left_1(new PassingControlLine(PassingControlLine::buildData(lanelet::utils::getId(), {ll_1.leftBound()}, {}, {})));
  ll_1.addRegulatoryElement(pcl_left_1);

  // 8. create passable control line from either side on first lanelet
  std::shared_ptr<PassingControlLine> pcl_right_1(new PassingControlLine(PassingControlLine::buildData(lanelet::utils::getId(), {ll_1.rightBound()}, {lanelet::Participants::Vehicle}, {lanelet::Participants::Vehicle})));
  ...
  std::shared_ptr<PassingControlLine> pcl_left_2(new PassingControlLine(PassingControlLine::buildData(lanelet::utils::getId(), {ll_3.leftBound(), ll_4.leftBound()}, {}, {})));
  std::shared_ptr<PassingControlLine> pcl_right_2(new PassingControlLine(PassingControlLine::buildData(lanelet::utils::getId(), {ll_2.rightBound(), ll_3.rightBound(), ll_4.rightBound()}, {}, {})));
  ...
  std::shared_ptr<PassingControlLine> pcl_area(new PassingControlLine(PassingControlLine::buildData(lanelet::utils::getId(), {area.outerBound()[1]}, {lanelet::Participants::Vehicle}, {lanelet::Participants::Vehicle})));
